...
public class EliumiteGas extends BlockFluidClassic
{
	...
	{
	    if(world.getBlock(x, y - 1, z) == Blocks.lit_pumpkin || world.getBlock(x, y + 1, z) == Blocks.lit_pumpkin || world.getBlock(x - 1, y, z) == Blocks.lit_pumpkin || world.getBlock(x + 1, y, z) == Blocks.lit_pumpkin || world.getBlock(x, y, z - 1) == Blocks.lit_pumpkin || world.getBlock(x, y, z + 1) == Blocks.lit_pumpkin ||
	      (world.getBlock(x, y - 1, z) == Blocks.lit_redstone_ore || world.getBlock(x, y + 1, z) == Blocks.lit_redstone_ore || world.getBlock(x - 1, y, z) == Blocks.lit_redstone_ore || world.getBlock(x + 1, y, z) == Blocks.lit_redstone_ore || world.getBlock(x, y, z - 1) == Blocks.lit_redstone_ore || world.getBlock(x, y, z + 1) == Blocks.lit_redstone_ore ||
	      (world.getBlock(x, y - 1, z) == Blocks.lit_furnace || world.getBlock(x, y + 1, z) == Blocks.lit_furnace || world.getBlock(x - 1, y, z) == Blocks.lit_furnace || world.getBlock(x + 1, y, z) == Blocks.lit_furnace || world.getBlock(x, y, z - 1) == Blocks.lit_furnace || world.getBlock(x, y, z + 1) == Blocks.lit_furnace ||
	      (world.getBlock(x, y - 1, z) == Blocks.netherrack || world.getBlock(x, y + 1, z) == Blocks.netherrack || world.getBlock(x - 1, y, z) == Blocks.netherrack || world.getBlock(x + 1, y, z) == Blocks.netherrack || world.getBlock(x, y, z - 1) == Blocks.netherrack || world.getBlock(x, y, z + 1) == Blocks.netherrack ||
	      (world.getBlock(x, y - 1, z) == Blocks.fire || world.getBlock(x, y + 1, z) == Blocks.fire || world.getBlock(x - 1, y, z) == Blocks.fire || world.getBlock(x + 1, y, z) == Blocks.fire || world.getBlock(x, y, z - 1) == Blocks.fire || world.getBlock(x, y, z + 1) == Blocks.fire ||
	      (world.getBlock(x, y - 1, z) == Blocks.powered_comparator || world.getBlock(x, y + 1, z) == Blocks.powered_comparator || world.getBlock(x - 1, y, z) == Blocks.powered_comparator || world.getBlock(x + 1, y, z) == Blocks.powered_comparator || world.getBlock(x, y, z - 1) == Blocks.powered_comparator || world.getBlock(x, y, z + 1) == Blocks.powered_comparator ||
