...
public class DCherryTree extends BlockSapling
{
	public DCherryTree()
	{
		super();
	...
	{
		blockIcon = iconregister.registerIcon("sevenno_addons:cherryTree");
	}
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random)
    {
        ...
        Object object = random.nextInt(10) == 0 ? new CherrygeGenBigTree(true) : new CherrygeGenBigTree(true);
        int i1 = 0;
        int j1 = 0;
        boolean flag = false;
