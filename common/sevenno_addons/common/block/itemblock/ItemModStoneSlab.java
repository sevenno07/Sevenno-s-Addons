...
public class ItemModStoneSlab extends ItemBlock
{
	private final boolean isFullBlock;
	private final Block theHalfSlab;
	private final Block doubleSlab;

	public ItemModStoneSlab(Block block)
	{
		super(block);
		this.theHalfSlab = SABlockList.ModStoneSlab;
		this.doubleSlab = SABlockList.ModStoneDoubleSlab;
		if(block.equals(SABlockList.ModStoneDoubleSlab))
		{
	...
	{
		return ((sevenno_addons.common.block.ModStoneSlab)theHalfSlab).func_150002_b(stack.getItemDamage());
	}
