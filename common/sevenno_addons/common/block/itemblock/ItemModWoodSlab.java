...
public class ItemModWoodSlab extends ItemBlock
{
	private final boolean isFullBlock;
	private final Block theHalfSlab;
	private final Block doubleSlab;

	public ItemModWoodSlab(Block block)
	{
		super(block);
		this.theHalfSlab = SABlockList.ModWoodSlab;
		this.doubleSlab = SABlockList.ModWoodDoubleSlab;
		if(block.equals(SABlockList.ModWoodDoubleSlab))
		{
	...
	{
		return ((sevenno_addons.common.block.ModWoodSlab)theHalfSlab).func_150002_b(stack.getItemDamage());
	}
