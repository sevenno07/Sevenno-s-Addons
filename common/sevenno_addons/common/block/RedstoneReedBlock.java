...
public class RedstoneReedBlock extends Block implements IPlantable
{
    protected RedstoneReedBlock()
    {
    ...
    {
        if (world.getBlock(par2, par3 - 1, par4) == SABlockList.RedstoneReedBlock || this.checkBlockCoordValid(world, par2, par3, par4))
        {
    ...
    public boolean canPlaceBlockAt(World world, int x, int y, int z)
    {
    	...
    	if (block == this)
    	{
    		return block == SABlockList.RedstoneReedBlock;
    	}
    ...
    {
        return SAItemList.RedstoneReed;
    }
