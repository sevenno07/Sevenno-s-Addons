...
public class EbonygeGenBigTree extends WorldGenAbstractTree
{
    public EbonygeGenBigTree(boolean p_i45463_1_)
    {
        super(p_i45463_1_);
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block3.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockSapling)SABlockList.DEbonyTree);
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j2 = 0; j2 < l; ++j2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, k3, k2, l1, SABlockList.ModLogs, 1);
                            i2 = k2;
                        }
                    }
                    ...
                    if (j2 != j3)
                    {
                        ...
                        for (l2 = k2; l2 < l && l3 > 0; --l3)
                        {
                            if (l2 >= 1)
                            {
                                ...
                                {
                                    this.setBlockAndNotifyAdequately(par1World, k3, i3, l1, SABlockList.ModLogs, 1);
                                    i2 = i3;
                                }
                            }
    ...
    private void func_150525_a(World p_150525_1_, int p_150525_2_, int p_150525_3_, int p_150525_4_)
    {
        ...
        {
            this.setBlockAndNotifyAdequately(p_150525_1_, p_150525_2_, p_150525_3_, p_150525_4_, SABlockList.DEbonyleaves, 1);
        }
    }
}