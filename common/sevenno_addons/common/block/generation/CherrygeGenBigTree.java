...
public class CherrygeGenBigTree extends WorldGenAbstractTree
{
    ...
    public CherrygeGenBigTree(boolean par1)
    {
        super(par1);
    }
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(par1, l, par3, f, (byte)1, SABlockList.DCherryleaves);
        }
    }

    void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block p_150530_3_, int m)
    {
    ...
    void generateTrunk()
    {
        ...
        this.func_150530_a(aint, aint1, SABlockList.ModLogs, 0);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.func_150530_a(aint, aint2, SABlockList.ModLogs, 0);
            }
        }
    }
    ...
    boolean validTreeLocation()
    {
        ...
        boolean isSoil = block.canSustainPlant(worldObj, basePos[0], basePos[1] - 1, basePos[2], ForgeDirection.UP, (BlockSapling)SABlockList.DCherryTree);
        if (!isSoil)
        {
            return false;
        }
