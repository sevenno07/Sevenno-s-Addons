...
public class IronReedBlock extends Block implements IPlantable
{
    protected IronReedBlock()
    {
    ...
    {
        if (world.getBlock(par2, par3 - 1, par4) == SABlockList.IronReedBlock || this.checkBlockCoordValid(world, par2, par3, par4))
        {
    ...
    public boolean canPlaceBlockAt(World world, int x, int y, int z)
    {
    	...
    	if (block == this)
    	{
    		return block == SABlockList.IronReedBlock;
    	}
