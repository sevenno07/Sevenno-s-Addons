...
public class DCherryleaves extends BlockLeaves implements IShearable
	{
	private IIcon fastIcon;

	public DCherryleaves()
	{
		super();
	...
	{
		blockIcon = iconregister.registerIcon("sevenno_addons:leaves_cherry");
		fastIcon = iconregister.registerIcon("sevenno_addons:leaves_cherry_opaque");
	}
	
    protected void CherryDrop(World world, int x, int y, int z, int par5, int par6)
    {
        if (world.rand.nextInt(par6) == 0)
        {
            this.dropBlockAsItem(world, x, y, z, new ItemStack(SAItemList.Cherry, 1, 0));
        }
    }
	...
	{
		return Item.getItemFromBlock(SABlockList.DCherryTree);
	}
    ...
    public void dropBlockAsItemWithChance(World world, int x, int y, int z, int par5, float par6, int par7)
    {
        if (!world.isRemote)
        {
            ...
            this.CherryDrop(world, x, y, z, par5, j1);
        }
    }
